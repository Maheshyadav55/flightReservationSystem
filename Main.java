...
public class Main {
    public static void main(String[] args){
        ...
        Passenger passenger1 = new Passenger("kothaguda", "Hyderabad", "telangana", "Sai Venkat"
                , " +91 9652008058", "maheshmahirocket30@gmail.com");
        Regular regularTicket = new Regular("1234ABC", "Hyderabad", "Mumbai", flight1, passenger1, 20,
                10000.0f, true, "Non Veg meal", "juice", "Chips");
